...
//        if (Gdx.app.getType() == Application.ApplicationType.Android) {
        if (Gdx.app.getType() == Application.ApplicationType.Desktop) {
            ...
            Button buttonPause = new Button(skin.getDrawable("bombButton"));
            buttonPause.setPosition(1080, 540);
            ...
            arrowGroup.addActor(buttonPause);

            Button buttonMenu = new Button(skin.getDrawable("downArrow"));
            buttonMenu.setPosition(1080, 450);
            ...
            arrowGroup.addActor(buttonMenu);
